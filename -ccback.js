...
document.getElementById("dmo").onclick = DMO;

function DMO() {
  document.getElementById("changement").disabled = true;
  document.getElementById("changement").value = "Set To Random";
}

document.getElementById("ran").onclick = DMO1;

function DMO1() {
  document.getElementById("changement").disabled = false;
  document.getElementById("changement").value = "";
}

document.getElementById("con").onclick = CON;

function CON() {
  document.getElementById("npack").disabled = true;
  document.getElementById("npack").value = "Continuous packets";
}

document.getElementById("ncon").onclick = NCON;

function NCON() {
  document.getElementById("npack").disabled = false;
  document.getElementById("npack").value = "";
}